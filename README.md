...
This project implements a diffusion-based framework for generating adversarial audio examples designed to fool speaker verification systems such as ECAPA, X-Vector, and ResNet-TDNN. It includes training code (test.py) and evaluation code (eval_new.py) for assessing attack success.
...
--attack_type: impersonation or evasion.
